...
Run this script once to add 10 sample shipments with events.
"""
from datetime import datetime, timedelta
import random
from app.database import SessionLocal
from app.models import Shipment, Event, User
...
def seed_database():
    ...
    try:
        ...
        # Create demo users
        demo_users = [
            {"email": "ops@demo.com", "name": "Ops User", "role": "ops", "password": "Demo123!"},
            {"email": "client@demo.com", "name": "Client User", "role": "client", "password": "Demo123!"},
        ]
        ...
        for i in range(1, 11):
            ...
            # Random progress (how many events to create)
            ...
            # Create events based on progress
            event_time = created
            for j in range(progress):
                ...
                event = Event(
                    ...
                    critical=(j in [2, 8])  # Seal cutoff and customs are critical
                )
                db.add(event)
            
            print(f"Created shipment: {ref} with {progress} events")
        
        db.commit()
        print("\n✅ Demo data seeded successfully!")
        print("Demo users created:")
        print("  - ops@demo.com / Demo123! (operational access)")
        print("  - client@demo.com / Demo123! (read-only)")
